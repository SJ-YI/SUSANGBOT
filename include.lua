...
HOME = HOME:gsub('Modules2.*$','')
-- HOME = HOME:gsub('Modules3.*$','')
...
package.cpath = HOME..'/Modules2/?/?.so;'..package.cpath
-- package.cpath = HOME..'/Modules3/?/?.so;'..package.cpath
-- Sometimes there are helper lua files (even for ffi, but still experimental)
package.path = HOME..'/Modules/?.lua;'..package.path
package.path = HOME..'/Modules2/?.lua;'..package.path
-- package.path = HOME..'/Modules3/?.lua;'..package.path
...
package.path = HOME..'/RunRobot/?.lua;'..package.path
