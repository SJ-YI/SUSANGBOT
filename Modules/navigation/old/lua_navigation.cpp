...
int lua_update_valuemap(lua_State *L){
  static std::vector<double> pose=lua_checkvector(L,1);
...
int lua_pathplan(lua_State *L){
  ...
  update_valuemap(pose[0],pose[1],pose[2],100);
...
static const struct luaL_Reg lib [] = {
  ...
  {"update_valuemap", lua_update_valuemap},
