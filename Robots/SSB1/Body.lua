...
-- local Kinematics = require'4LegKinematics'
...
-- Kinematics.init(
--   Config.legparam.shoulderOffset,
--   Config.legparam.shoulderToLegY,
--   Config.legparam.upperLegLength,
--   Config.legparam.lowerLegLength,
--   Config.legparam.lowerLegAngle,
--   Config.legparam.footZ,
--   Config.legparam.leg_ff
-- )
